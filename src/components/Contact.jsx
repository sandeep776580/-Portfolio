...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
          ...
          {
            from_name: form.name,
            to_name: "Abhikant Kumar",
            from_email: form.email,
            to_email: "abhiparnav12@gmail.com",
      ...
      <motion.div variants={slideIn("left", "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl" >
        ...
        <form ref={formRef} className="mt-12 flex flex-col gap-8" onSubmit={handleSubmit} >
          ...
          <label className="flex flex-col">
            ...
            <textarea rows="7" name="message" value={form.message} onChange={handleChange} placeholder="What do want to say?"  className="bg-tertiary py-4 px-6  placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"/>
          </label>
